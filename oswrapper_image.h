...
#ifdef EMSCRIPTEN
#if !defined(OSWRAPPER_IMAGE_USE_EMSCRIPTEN_PRELOAD_IMPL) && !defined(OSWRAPPER_IMAGE_NO_USE_EMSCRIPTEN_PRELOAD_IMPL)
#define OSWRAPPER_IMAGE_USE_EMSCRIPTEN_PRELOAD_IMPL
#endif /* !defined(OSWRAPPER_IMAGE_USE_EMSCRIPTEN_PRELOAD_IMPL) && !defined(OSWRAPPER_IMAGE_NO_USE_EMSCRIPTEN_PRELOAD_IMPL) */
#endif
