...
static OSWrapper_audio_enc_output_type demo_get_enum_for_str(const char* type) {
    ...
    } else if (strcmp_impl(type, "aac-lc") == 0) {
        return OSWRAPPER_AUDIO_ENC_OUPUT_FORMAT_AAC_LC;
    } else if (strcmp_impl(type, "aac-he") == 0) {
        return OSWRAPPER_AUDIO_ENC_OUPUT_FORMAT_AAC_HE;
    } else if (strcmp_impl(type, "aac-he-v2") == 0) {
        return OSWRAPPER_AUDIO_ENC_OUPUT_FORMAT_AAC_HE_V2;
    } else if (strcmp_impl(type, "mp2") == 0 || strcmp_impl(type, "mpg") == 0) {
    ...
    } else if (strcmp_impl(type, "wma-v8") == 0 || strcmp_impl(type, "wma") == 0) {
        return OSWRAPPER_AUDIO_ENC_OUPUT_FORMAT_WMA_V8;
    } else if (strcmp_impl(type, "opus") == 0) {
        return OSWRAPPER_AUDIO_ENC_OUPUT_FORMAT_OPUS;
    } else if (strcmp_impl(type, "ilbc") == 0) {
        return OSWRAPPER_AUDIO_ENC_OUPUT_FORMAT_ILBC;
    } else if (strcmp_impl(type, "caf-pcm") == 0) {
        return OSWRAPPER_AUDIO_ENC_OUPUT_FORMAT_CAF_PCM;
    } else {
        return OSWRAPPER_AUDIO_ENC_OUPUT_FORMAT_WAV;
    }
}
